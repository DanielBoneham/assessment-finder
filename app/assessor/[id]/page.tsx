          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,2fr) minmax(0,1fr)', gap: '24px', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ background: '#f0fdf4', borderRadius: '12px', border: '1px solid #86efac', padding: '1.25rem 1.5rem', display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#dcfce7', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: '16px' }}>✓</div>
                <div>
                  ...
                  <p style={{ fontSize: '13px', color: '#166534', margin: 0, opacity: 0.85, lineHeight: 1.5 }}>
                    {assessor.is_verified
                      ? 'Identity and professional credentials have been checked by Assessment Finder.'
                      : 'This profile has been reviewed by the Assessment Finder team before being published.'}
                  </p>
                </div>
              </div>
